...
// 🔹 Funkcja do Haptic Feedback (Taptic Engine dla iPhone)
function triggerHapticFeedback(type = "light") {
    if ("vibrate" in navigator) {
        // Android: krótka wibracja
        navigator.vibrate(50);
        console.log("📳 Wibracja na Androidzie!");
        ...
        try {
            ...
            console.log("📳 Wibracja na iPhonie (Taptic Engine)!");
        } catch (err) {
            console.warn("⚠ Brak wsparcia dla Haptic Feedback na iOS", err);
        }
    } else {
        console.log("⚠ Brak wsparcia dla Haptic Feedback.");
    }
}
